...
const pool = new Pool({
    host: 'ec2-3-86-101-143.compute-1.amazonaws.com',
    port: 5432,
    password: '12345',
    user: 'postgres',
    database: 'reviews',
...
const searchmeta = (product_id) => {
    return pool.connect()
        .then((client) => {
            return client.query(`explain analyze select reviews.id as rid,rating, name,characteristics.id, value,recommend
